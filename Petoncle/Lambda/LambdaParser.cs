...
internal class LambdaParser
{
    ...
    internal virtual void ParseMember(MemberExpression expression)
    {
        ...
        else
        {
            ...
            string argumentName = _queryBuilder.RegisterArgument(value);
            _queryBuilder.Append(argumentName);
        }
    ...
    {
        string argument = _queryBuilder.RegisterArgument(expression.Value);
    ...
    internal bool GetValueFromExpression(Expression expression, out object obj)
    {
        ...
        else if (expression is MemberExpression memberExpression && _tableDefinition.Type != null &&
                 memberExpression.Member.DeclaringType == _tableDefinition.Type)
